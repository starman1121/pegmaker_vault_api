...
const tokenLists = {
  ...
  fantom: ['https://raw.githubusercontent.com/krypto-dev/comet-autovault/main/src/tokenlist.json']
};
...
(async () => {
  const chainId = chainIdMap.fantom;
  let tokens: Token[] = [];
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  let tokenListFinal: any;
  for (const tokenList of tokenLists.fantom) {
